...
var peer_score = 0
var my_choice = null   
var peer_choice = null  # ← null et non false
...
func _faire_choix(choix: bool):
	...
	# MODE LOCAL 
	var choix_adverse = [true, false].pick_random()
	_recevoir_choix_adverse(choix_adverse)
...
func _resoudre_manche():
	...
	# Attendre 2 secondes avant nouvelle manche
	await get_tree().create_timer(2.0).timeout
	if round < 5 :
		round +=1
		_nouvelle_manche()
	else : 
		label_attente.text = "Partie Terminé"
